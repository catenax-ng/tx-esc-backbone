...
type ResourceMap struct {
	...
	AuditLogs  *Audit    `protobuf:"bytes,4,opt,name=auditLogs,proto3" json:"auditLogs,omitempty"`
}
...
func (m *ResourceMap) GetOriginator() string {
	if m != nil {
		return m.Originator
	}
	return ""
...
func (m *ResourceMap) GetOrigResId() string {
	if m != nil {
		return m.OrigResId
	}
	return ""
...
func (m *ResourceMap) GetResource() *Resource {
	if m != nil {
		return m.Resource
	}
	return nil
...
var fileDescriptor_d6147e3f06a83316 = []byte{
	...
	0x9c, 0x0a, 0x13, 0x4b, 0x53, 0x32, 0x4b, 0x20, 0xaa, 0x94, 0x4e, 0x31, 0x72, 0x71, 0x07, 0x41,
	0x25, 0x7d, 0x13, 0x0b, 0x84, 0xe4, 0xb8, 0xb8, 0xf2, 0x8b, 0x32, 0xd3, 0x33, 0xf3, 0x12, 0x4b,
	0xf2, 0x8b, 0x24, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x90, 0x44, 0x84, 0x64, 0xb8, 0x38, 0x41,
	0xbc, 0xa0, 0xd4, 0x62, 0xcf, 0x14, 0x09, 0x26, 0xb0, 0x34, 0x42, 0x40, 0xc8, 0x8e, 0x8b, 0x03,
	0x66, 0x93, 0x04, 0xb3, 0x02, 0xa3, 0x06, 0xb7, 0x91, 0x92, 0x1e, 0x2e, 0x9f, 0xe8, 0xc1, 0xac,
	0x0d, 0x82, 0xeb, 0x11, 0xb2, 0xe5, 0xe2, 0x04, 0x3b, 0xce, 0x27, 0x3f, 0xbd, 0x58, 0x82, 0x05,
	0x6c, 0x80, 0x3c, 0x6e, 0x03, 0x1c, 0x41, 0x4a, 0x83, 0x10, 0x3a, 0x9c, 0xfc, 0x4e, 0x3c, 0x92,
	...
	0x39, 0x3f, 0x57, 0x3f, 0x39, 0xb1, 0x24, 0x35, 0x2f, 0xb1, 0x42, 0x3f, 0xb5, 0x38, 0x59, 0x17,
	0x1e, 0x40, 0x15, 0xa8, 0x41, 0x54, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x0e, 0x23, 0x63,
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6f, 0xe7, 0x78, 0x7c, 0xbb, 0x01, 0x00, 0x00,
}
...
func (m *ResourceMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrigResId) > 0 {
		...
		i = encodeVarintResourceMap(dAtA, i, uint64(len(m.OrigResId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Originator) > 0 {
		...
		i = encodeVarintResourceMap(dAtA, i, uint64(len(m.Originator)))
		i--
		dAtA[i] = 0xa
	}
